...
<body>
        ...
        <div class="attendance-container row">
            <div class="qr-container col-4">
                <div class="scanner-con">
                    <h5 class="text-center">Escanea Tu QR aqui</h5>
                    <video id="interactive" class="viewport" width="100%">
                </div>

                <div class="qr-detected-container" style="display: none;">
                    <form action="./endpoint/add-attendance.php" method="POST">
                        <h4 class="text-center"> QR del estudiante Detectado!</h4>
                        <input type="hidden" id="detected-qr-code" name="qr_code">
                        <button type="submit" class="btn btn-dark form-control">Registrar asitencia</button>
                    </form>
                </div>
            </div>

            <div class="attendance-list">
                <h4>Lista de estudiantes presentes</h4>
    ...
    <script>
            ...
            Instascan.Camera.getCameras()
                .then(function (cameras) {
                    if (cameras.length > 0) {
                        ...
                        console.error('La camara no esta funcionando.');
                        alert('La camara no esta funcionando.');
                    }
                })
                .catch(function (err) {
                    console.error('Error en acceso a Camara:', err);
                    alert('Error en acceso a camara: ' + err);
                });
        }
        ...
        function deleteAttendance(id) {
            if (confirm("Desea borrar la asistenia del estudiante?")) {
